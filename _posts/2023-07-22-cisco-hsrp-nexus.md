...
Paso 2: Ingresar a la interfaz de interfaz de VLAN
...
Paso 3: Configurar la dirección IP de la interfaz VLAN
...
Paso 4: Habilitar HSRP versión 2 en la interfaz VLAN
...
Paso 5: Configurar el grupo HSRP
...
Paso 6: Configurar la prioridad del router HSRP (opcional)
...
Paso 7: Configurar el temporizador HSRP (opcional)
...
Paso 8: Salir y guardar la configuración
